Ext.onReady(function(){
   ...
   var record_start = 0;
	...
	var gridPanelDataStore = new Ext.data.JsonStore({
    		url: 'A_OnuServiceImpl!query.zdy',
    		baseParams:{start:0,limit:50},
    		root: 'beenList',
    		totalProperty : 'totalCount',
    		fields: ['onuId','onuName','siteId','siteName','projectId','projectName','installationSite',
    				 'manufacturersId','manufacturersName','typeSpecification','constructionUnitId','constructionUnitName','runTime',
    				 'vlanId','ospfNumber','vpnNumber','delFlg','descp']
		});
/********************************************* Form集合 ***********************************************************/
     	 /** form的提示信息位置 */
    	...
    	var formPanel_view = new Ext.FormPanel({
						        title: 'onu-查看',labelWidth:100,frame:true, 
						        ...
						        items: [{
							        		items:[{
							        				...
							        				items:[{id:"viewOnuName",fieldLabel:'<font color="red">(*)</font>onu名称'}]
							        		}]
						            	},{
							            	 items:[{
									            	...
									            	items:[{id:"viewProjectName",fieldLabel:'<font color="red">(*)</font>所属项目 '},
									            		   ...
									            		   {id:"viewOspfNumber",fieldLabel:'ospf进程号'},
    	...
    	var formPanel_add = new Ext.FormPanel({
						        title: 'onu-新增',labelWidth:100,frame:true, 
						        url:'A_OnuServiceImpl!add.zdy',
						        defaults:{xtype: 'panel',layout: 'column',anchor:'100%'},
						        items:[{
						        		items:[{
						        				layout:'form',columnWidth:1,defaultType:'textfield', 
						        				...
						        				items:[{	
						        						name:'A_Onu.onuName',fieldLabel:'<font color="red">(*)</font>onu名称',
    													emptyText:"请输入onu名称",allowBlank:false,blankText:"onu名称不能为空" 
    											}]
						        		}]
						            },{
						            	items:[{
								            	...
								            	items:[{
										            		name:'A_Onu.siteId',xtype:'combo',fieldLabel:'<font color="red">(*)</font>所属站点',
										                	emptyText:'请选择所属站点',allowBlank:false,blankText:'所属站点不能为空',
										                	mode:'local',store:siteDataStore,hiddenName:'A_Onu.siteId',
										               		displayField:'siteName',valueField:'siteId',
										               	 	typeAhead:true,triggerAction:'all',forceSelection:true
								            	 	   },{
						              				 		name:'A_Onu.installationSite',fieldLabel:'安装地址'
						            				   },{
									               			name:'A_Onu.typeSpecification',fieldLabel:'型号规格'
									            	   },{
									               			name:'A_Onu.runTime',xtype:'datefield',fieldLabel:'投运时间',
									               			maxValue: new Date(),format:'Y-m-d',
						                					invalidText:"输入的日期格式不正确，请参考格式‘2014-01-01’格式"
									            	   },{
									               			 name:'A_Onu.vpnNumber',fieldLabel:'vpn实例名'
									            	   }]
								            },{
								            	layout:'form',columnWidth:.5,defaultType:'textfield',
								            	defaults:{labelStyle:"text-align:right;",anchor:'90%'}, 
								            	items:[{
						                					...
						                					name:'A_Onu.manufacturersId',xtype:'combo',fieldLabel:'<font color="red">(*)</font>所属厂家',
											                emptyText:'请选择所属厂家',allowBlank:false,blankText:'所属厂家不能为空',
											                mode:'local',store:manufacturersDataStore,hiddenName:'A_Onu.manufacturersId',
											                displayField:'manufacturersName',valueField:'manufacturersId',
											                typeAhead:true,triggerAction:'all',forceSelection:true
						           					},{
											                name:'A_Onu.constructionUnitId',xtype:'combo',fieldLabel:'<font color="red">(*)</font>施工单位',
											                emptyText:"请选择施工单位'",allowBlank:false,blankText:"施工单位'不能为空",
											                mode:'local',store:constructionUnitDataStore,hiddenName:'A_Onu.constructionUnitId',
											                displayField:'constructionUnitName',valueField:'constructionUnitId',
											                typeAhead:true,triggerAction:'all',forceSelection:true
									            	},{
						                					name:'A_Onu.vlanId',fieldLabel:'vlanId'
						           					},{
						                					name:'A_Onu.ospfNumber',fieldLabel:'ospf进程号'
						           					},{
						        		...
						        		items:[{
						        				layout:'form',columnWidth:1,defaultType:'textfield', 
						            	 		defaults:{labelStyle:"text-align:right;",anchor:'95%'},
						        				items:[{	
						        					name:'A_Onu.descp',fieldLabel:'备注',xtype:'textarea'
    											}]
						        		}]
						           }
						        ]
    	...
    	var formPanel_update = new Ext.FormPanel({
						        title: 'onu-更新',labelWidth:100,frame:true, 
						        url:'A_OnuServiceImpl!update.zdy',
						        defaults:{xtype: 'panel',layout: 'column',anchor:'100%'},
						       	items:[{
						        		items:[{
						        				layout:'form',columnWidth:1,defaultType:'textfield', 
						            	 		defaults:{labelStyle:"text-align:right;",anchor:'95%'},
						        				items:[{
						        						id:'updateOnuId',name:'A_Onu.onuId',hidden:true
						        				},{	
						        						id:'updateOnuName',name:'A_Onu.onuName',fieldLabel:'<font color="red">(*)</font>onu名称',
    													emptyText:"请输入onu名称",allowBlank:false,blankText:"onu名称不能为空" 
    											}]
						        		}]
						            },{
						            	items:[{
						            	 		...
						            	 		defaults:{labelStyle:"text-align:right;",anchor:'90%'},
								            	items:[{
										            	id:'updateSiteId',name:'A_Onu.siteId',xtype:'combo',fieldLabel:'<font color="red">(*)</font>所属站点',
										                emptyText:'请选择所属站点',allowBlank:false,blankText:'所属站点不能为空',
										                mode:'local',store:siteDataStore,hiddenName:'A_Onu.siteId',
										               	displayField:'siteName',valueField:'siteId',
										               	typeAhead:true,triggerAction:'all',forceSelection:true
								            	 	   },{
						              				 	id:'updateInstallationSite',name:'A_Onu.installationSite',fieldLabel:'安装地址'
						            				   },{
									               		id:'updateTypeSpecification',name:'A_Onu.typeSpecification',fieldLabel:'型号规格'
									            	   },{
									               		id:'updateRunTime',name:'A_Onu.runTime',xtype:'datefield',fieldLabel:'投运时间',
									               		maxValue: new Date(),format:'Y-m-d',
						                				invalidText:"输入的日期格式不正确，请参考格式‘2014-01-01’格式"
									            	   },{
									               		id:'updateVpnNumber',name:'A_Onu.vpnNumber',fieldLabel:'vpn实例名'
									            	   }]
								            },{
								            	layout:'form',columnWidth:.5,defaultType:'textfield',
								            	defaults:{labelStyle:"text-align:right;",anchor:'90%'}, 
								            	items:[{
						                				...
						                				id:'updateManufacturersId',name:'A_Onu.manufacturersId',xtype:'combo',fieldLabel:'<font color="red">(*)</font>所属厂家',
											            emptyText:'请选择所属厂家',allowBlank:false,blankText:'所属厂家不能为空',
											            mode:'local',store:manufacturersDataStore,hiddenName:'A_Onu.manufacturersId',
											            displayField:'manufacturersName',valueField:'manufacturersId',
											            typeAhead:true,triggerAction:'all',forceSelection:true
						           					},{
											            id:'updateConstructionUnitId',name:'A_Onu.constructionUnitId',xtype:'combo',fieldLabel:'<font color="red">(*)</font>施工单位',
											            emptyText:"请选择施工单位'",allowBlank:false,blankText:"施工单位'不能为空",
											            mode:'local',store:constructionUnitDataStore,hiddenName:'A_Onu.constructionUnitId',
											            displayField:'constructionUnitName',valueField:'constructionUnitId',
											            typeAhead:true,triggerAction:'all',forceSelection:true
									            	},{
						                				id:'updateVlanId',name:'A_Onu.vlanId',fieldLabel:'vlanId'
						           					},{
						                				id:'updateOspfNumber',name:'A_Onu.ospfNumber',fieldLabel:'ospf进程号'
						           					},{
						        		...
						        		items:[{
						        				layout:'form',columnWidth:1,defaultType:'textfield', 
						            	 		defaults:{labelStyle:"text-align:right;",anchor:'95%'},
						        				items:[{	
						        					id:'updateDescp',name:'A_Onu.descp',fieldLabel:'备注',xtype:'textarea'
    											}]
						        		}]
						           }
						        ]
		...
		var formPanel_import = new Ext.FormPanel({
						        title: 'onu-上传',labelWidth:100,
						        frame:true,fileUpload :true,
						        url:'A_OnuServiceImpl!importExcel.zdy',
						        ...
						        buttons: [{
						            ...
						            handler:function(){
									   Ext.Ajax.request({
											url: 'A_OnuServiceImpl!downloadExcel.zdy',
 ...
 /********************************************** Grid ***********************************************************/
   ...
   var functionGridPanel =  new Ext.grid.GridPanel({
        renderTo:"grid-size",title:'基础列表>>onu', width:Ext.get("grid-size").getWidth(),height:Ext.get("grid-size").getHeight(),
        ...
        cm: new Ext.grid.ColumnModel([sm,
            ...
            {header:"onu名称", width: 140, sortable:true,dataIndex:'onuName'},
            	 	...
            	 	var _record = functionGridPanel.getSelectionModel().getSelected();
           		 	if (_record){ 
           		 		var _jsonData = functionGridPanel.getSelectionModel().getSelections()[0];
			 				Ext.getCmp("updateOnuId").setValue(_jsonData.get("onuId"));
							Ext.getCmp("updateOnuName").setValue(_jsonData.get("onuName"));
           		 ...
           		 handler:function(){
           		 	...
           		 	if (_record){
           		 		Ext.MessageBox.confirm('确认启用', '确认要启用选择的数据吗？', function(btn){
								...
								for (var i = 0;i <len; i++){
									if (i == 0) {
										_jsonData = _jsonData +  m[i].get("onuId");
									} else {
										_jsonData = _jsonData + "," +  m[i].get("onuId");
									}
								}
								/** 更新相应记录 */
								Ext.Ajax.request({
									   url: 'A_OnuServiceImpl!effective.zdy',
           		 ...
           		 handler:function(){
           		 	...
           		 	if (_record){
           		 		Ext.MessageBox.confirm('确认停用', '确认要停用选择的数据吗？', function(btn){
								...
								/** 更新相应记录 */
								Ext.Ajax.request({
									   url: 'A_OnuServiceImpl!invalid.zdy',
									   params: {"ids":_jsonData},
									   success: function(response,options){
									   		 ajaxSuccess(response,options);
									   },
           		 ...
           		 handler:function(){
           		 	...
           		 	if (_record){
           		 		Ext.MessageBox.confirm('确认删除', '确认要删除选择的数据吗？', function(btn){
								...
								/** 更新相应记录 */
								Ext.Ajax.request({
									   url: 'A_OnuServiceImpl!delete.zdy',
									   params: {"ids":_jsonData},
									   success: function(response,options){
									   		ajaxSuccess(response,options);
									   },
   ...
   /*********************************************** 事件初始化*******************************************************/
	...
	var onrowdoubleclick = function(functionGridPanel, index, e){
         ...
         if (_record){
           	var _jsonData = functionGridPanel.getSelectionModel().getSelections()[0];
			Ext.getCmp("viewOnuName").setValue(_jsonData.get("onuName"));
	...
	function conditionFiledSelect(){
		...
		}else if(Ext.getCmp('conditionFiled').getValue()=='onu.runTime'){
