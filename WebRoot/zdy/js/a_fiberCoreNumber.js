						            	...
						            	if (formPanel_update.form.isValid()) {
							            		Ext.Ajax.request({
													   ...
													   params: {
													   		...
													   		"A_FiberCoreNumber.startConnections":Ext.getCmp('updateStartConnections').getValue(),
													   		"A_FiberCoreNumber.endConnections":Ext.getCmp('updateEndConnections').getValue(),
