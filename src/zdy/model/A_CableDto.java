 ...
 * @version 1.0
 */
public class A_CableDto extends TemplateBeen {
	/** 业务主键 */
	...
	/**
	 * @param cableName the cableName to set
	 */
	...
	/**
	 * @param cableStartId the cableStartId to set
	 */
	...
	/**
	 * @param cableEndId the cableEndId to set
	 */
	...
	/**
	 * @param layingType the layingType to set
	 */
