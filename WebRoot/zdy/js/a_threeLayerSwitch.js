Ext.onReady(function(){
   ...
   var record_start = 0;
    /** combo下拉框-字段local初始化 */
    var conditionFiledStore = [['threeLayerSwitch.threeLayerSwitchName','设备名称'],['threeLayerSwitch.siteId','所属站点'],['threeLayerSwitch.projectId','所属项目'],
   							   ['threeLayerSwitch.installationSite','安装地址'],['threeLayerSwitch.manufacturersId','所属厂家'],['threeLayerSwitch.typeSpecification','型号规格'],
    						   ['threeLayerSwitch.constructionUnitId','施工单位'],['threeLayerSwitch.runTime','投运时间'],['threeLayerSwitch.portNumber','端口号'],
    						   ['threeLayerSwitch.flow','流量'],['threeLayerSwitch.vlanId','vlanId'],['threeLayerSwitch.ip','IP地址'],
    						   ['threeLayerSwitch.vlanDescp','vlan备注'],['threeLayerSwitch.delFlg','是否启用'],['threeLayerSwitch.descp','备注']];
	...
	var gridPanelDataStore = new Ext.data.JsonStore({
    		url: 'A_ThreeLayerSwitchServiceImpl!query.zdy',
    		baseParams:{start:0,limit:50},
    		root: 'beenList',
    		totalProperty : 'totalCount',
    		fields: ['threeLayerSwitchId','threeLayerSwitchName','siteId','siteName','projectId','projectName','installationSite',
    				 'manufacturersId','manufacturersName','typeSpecification','constructionUnitId','constructionUnitName','runTime',
    				 'portNumber','flow','vlanId','ip','vlanDescp','vlanDescp','delFlg','descp']
		});
/********************************************* Form集合 ***********************************************************/
     	 /** form的提示信息位置 */
    	...
    	var formPanel_view = new Ext.FormPanel({
						        title: '三层交换机-查看',labelWidth:100,frame:true, 
						        ...
						        items: [{
							        		items:[{
							        				...
							        				items:[{id:"viewThreeLayerSwitchName",fieldLabel:'<font color="red">(*)</font>设备名称'}]
							        		}]
						            	},{
							            	 items:[{
									            	...
									            	items:[{id:"viewProjectName",fieldLabel:'<font color="red">(*)</font>所属项目'},
									            		   ...
									            		   {id:"viewVlanDescp",fieldLabel:'备注/其他'}] 
							            	}]
						              },{
							        		items:[{
								        			layout:'form',columnWidth:1,defaultType:'textfield', 
    	...
    	var formPanel_add = new Ext.FormPanel({
						        title: '三层交换机-新增',labelWidth:100,frame:true, 
						        url:'A_ThreeLayerSwitchServiceImpl!add.zdy',
						        defaults:{xtype: 'panel',layout: 'column',anchor:'100%'},
						        items:[{
						        		items:[{
						        				layout:'form',columnWidth:1,defaultType:'textfield', 
						        				...
						        				items:[{	
						        						name:'A_ThreeLayerSwitch.threeLayerSwitchName',fieldLabel:'<font color="red">(*)</font>设备名称',
						            	...
						            	items:[{
								            	...
								            	items:[{
										            		name:'A_ThreeLayerSwitch.siteId',xtype:'combo',fieldLabel:'<font color="red">(*)</font>所属站点',
										                	emptyText:'请选择所属站点',allowBlank:false,blankText:'所属站点不能为空',
										                	mode:'local',store:siteDataStore,hiddenName:'A_ThreeLayerSwitch.siteId',
										               		displayField:'siteName',valueField:'siteId',
										               	 	typeAhead:true,triggerAction:'all',forceSelection:true
								            	 	   },{
						              				 		name:'A_ThreeLayerSwitch.installationSite',fieldLabel:'安装地址'
						            				   },{
									               			name:'A_ThreeLayerSwitch.typeSpecification',fieldLabel:'型号规格'
									            	   },{
									               			name:'A_ThreeLayerSwitch.runTime',xtype:'datefield',fieldLabel:'投运时间',
									               			maxValue: new Date(),format:'Y-m-d',
						                					invalidText:"输入的日期格式不正确，请参考格式‘2014-01-01’格式"
									            	   },{
									               			name:'A_ThreeLayerSwitch.flow',fieldLabel:'流量'
									            	   },{
									               			name:'A_ThreeLayerSwitch.ip',fieldLabel:'IP地址'
									            	   },{
											            	name:'A_ThreeLayerSwitch.delFlg',xtype:'combo',fieldLabel:'<font color="red">(*)</font>是否启用',
								            	...
								            	defaults:{labelStyle:"text-align:right;",anchor:'90%'}, 
								            	items:[{
										            		name:'A_ThreeLayerSwitch.projectId',xtype:'combo',fieldLabel:'<font color="red">(*)</font>所属项目',
										               	 	emptyText:'请选择所属项目',allowBlank:false,blankText:'所属项目不能为空',
										               	 	mode:'local',store:projectDataStore,hiddenName:'A_ThreeLayerSwitch.projectId',
										                	displayField:'projectName',valueField:'projectId',
										                	typeAhead:true,triggerAction:'all',forceSelection:true
								            			},{
						                					name:'A_ThreeLayerSwitch.manufacturersId',xtype:'combo',fieldLabel:'<font color="red">(*)</font>所属厂家',
											                emptyText:'请选择所属厂家',allowBlank:false,blankText:'所属厂家不能为空',
											                mode:'local',store:manufacturersDataStore,hiddenName:'A_ThreeLayerSwitch.manufacturersId',
											                displayField:'manufacturersName',valueField:'manufacturersId',
											                typeAhead:true,triggerAction:'all',forceSelection:true
						           						},{
									               			name:'A_ThreeLayerSwitch.constructionUnitId',xtype:'combo',fieldLabel:'<font color="red">(*)</font>施工单位',
											                emptyText:'请选择施工单位',allowBlank:false,blankText:'施工单位不能为空',
											                mode:'local',store:constructionUnitDataStore,hiddenName:'A_ThreeLayerSwitch.constructionUnitId',
											                displayField:'constructionUnitName',valueField:'constructionUnitId',
											                typeAhead:true,triggerAction:'all',forceSelection:true
									          			},{
						                					name:'A_ThreeLayerSwitch.portNumber',fieldLabel:'端口号'
						           						},{
						                					name:'A_ThreeLayerSwitch.vlanId',fieldLabel:'vlanId'
						           						},{
									               			 name:'A_ThreeLayerSwitch.vlanDescp',fieldLabel:'备注/其他'
									              		}] 
						            	}]
						            },{
						        		items:[{
						        				layout:'form',columnWidth:1,defaultType:'textfield', 
						            	 		defaults:{labelStyle:"text-align:right;",anchor:'95%'},
						        				items:[{	
						        					name:'A_ThreeLayerSwitch.descp',fieldLabel:'备注',xtype:'textarea'
    											}]
						        		}]
						           }
						        ]
    	...
    	var formPanel_update = new Ext.FormPanel({
						        title: '三层交换机-更新',labelWidth:100,frame:true, 
						        url:'A_ThreeLayerSwitchServiceImpl!update.zdy',
						        defaults:{xtype: 'panel',layout: 'column',anchor:'100%'},
						       	items:[{
						        		items:[{
						        				layout:'form',columnWidth:1,defaultType:'textfield', 
						            	 		defaults:{labelStyle:"text-align:right;",anchor:'95%'},
						        				items:[{
						        						id:'updateThreeLayerSwitchId',name:'A_ThreeLayerSwitch.threeLayerSwitchId',hidden:true
						        				},{	
						        						id:'updateThreeLayerSwitchName',name:'A_ThreeLayerSwitch.threeLayerSwitchName',fieldLabel:'<font color="red">(*)</font>设备名称',
    													emptyText:"请输入设备名称",allowBlank:false,blankText:"设备名称不能为空" 
    											}]
						        		}]
						            },{
						            	items:[{
						            	 		...
						            	 		defaults:{labelStyle:"text-align:right;",anchor:'90%'},
								            	items:[{
										            	id:'updateSiteId',name:'A_ThreeLayerSwitch.siteId',xtype:'combo',fieldLabel:'<font color="red">(*)</font>所属站点',
										                emptyText:'请选择所属站点',allowBlank:false,blankText:'所属站点不能为空',
										                mode:'local',store:siteDataStore,hiddenName:'A_ThreeLayerSwitch.siteId',
										               	displayField:'siteName',valueField:'siteId',
										               	typeAhead:true,triggerAction:'all',forceSelection:true
								            	 	},{
						              				 	id:'updateInstallationSite',name:'A_ThreeLayerSwitch.installationSite',fieldLabel:'安装地址'
						            				},{
									               		id:'updateTypeSpecification',name:'A_ThreeLayerSwitch.typeSpecification',fieldLabel:'型号规格'
									            	},{
									               		id:'updateRunTime',name:'A_ThreeLayerSwitch.runTime',xtype:'datefield',fieldLabel:'投运时间',
									               		maxValue: new Date(),format:'Y-m-d',
						                				invalidText:"输入的日期格式不正确，请参考格式‘2014-01-01’格式"
									            	},{
									               		id:'updateFlow',name:'A_ThreeLayerSwitch.flow',fieldLabel:'流量'
									            	},{
									               		id:'updateIp',name:'A_ThreeLayerSwitch.ip',fieldLabel:'IP地址'
									            	},{
											            id:'updateDelFlg',name:'A_ThreeLayerSwitch.delFlg',xtype:'combo',fieldLabel:'<font color="red">(*)</font>是否启用',
											            emptyText:"请选择是否启用",allowBlank:false,blankText:"是否启用不能为空",
											            mode:'local',store:delFlgStore,
											            typeAhead:true,triggerAction:'all',forceSelection:true
								             	}]
								            	...
								            	defaults:{labelStyle:"text-align:right;",anchor:'90%'}, 
								            	items:[{
										            	id:'updateProjectId',name:'A_ThreeLayerSwitch.projectId',xtype:'combo',fieldLabel:'<font color="red">(*)</font>所属项目',
										               	emptyText:'请选择所属项目',allowBlank:false,blankText:'所属项目不能为空',
										               	mode:'local',store:projectDataStore,hiddenName:'A_ThreeLayerSwitch.projectId',
										                displayField:'projectName',valueField:'projectId',
										                typeAhead:true,triggerAction:'all',forceSelection:true
								            		},{
						                				id:'updateManufacturersId',name:'A_ThreeLayerSwitch.manufacturersId',xtype:'combo',fieldLabel:'<font color="red">(*)</font>所属厂家',
											            emptyText:'请选择所属厂家',allowBlank:false,blankText:'所属厂家不能为空',
											            mode:'local',store:manufacturersDataStore,hiddenName:'A_ThreeLayerSwitch.manufacturersId',
											            displayField:'manufacturersName',valueField:'manufacturersId',
											            typeAhead:true,triggerAction:'all',forceSelection:true
						           					},{
									               		id:'updateConstructionUnitId',name:'A_ThreeLayerSwitch.constructionUnitId',xtype:'combo',fieldLabel:'<font color="red">(*)</font>施工单位',
											            emptyText:'请选择施工单位',allowBlank:false,blankText:'施工单位不能为空',
											            mode:'local',store:constructionUnitDataStore,hiddenName:'A_ThreeLayerSwitch.constructionUnitId',
											            displayField:'constructionUnitName',valueField:'constructionUnitId',
											            typeAhead:true,triggerAction:'all',forceSelection:true
									          		},{
						                				id:'updatePortNumber',name:'A_ThreeLayerSwitch.portNumber',fieldLabel:'端口号'
						           					},{
						                				id:'updateVlanId',name:'A_ThreeLayerSwitch.vlanId',fieldLabel:'vlanId'
						           					},{
									               		id:'updateVlanDescp',name:'A_ThreeLayerSwitch.vlanDescp',fieldLabel:'备注/其他'
									           }] 
						            	}]
						            },{
						        		items:[{
						        				layout:'form',columnWidth:1,defaultType:'textfield', 
						            	 		defaults:{labelStyle:"text-align:right;",anchor:'95%'},
						        				items:[{	
						        					id:'updateDescp',name:'A_ThreeLayerSwitch.descp',fieldLabel:'备注',xtype:'textarea'
    											}]
						        		}]
						           }
						        ]
		...
		var formPanel_import = new Ext.FormPanel({
						        title: '三层交换机-上传',labelWidth:100,
						        frame:true,fileUpload :true,
						        url:'A_ThreeLayerSwitchServiceImpl!importExcel.zdy',
						        ...
						        buttons: [{
						            ...
						            handler:function(){
									   Ext.Ajax.request({
											url: 'A_ThreeLayerSwitchServiceImpl!downloadExcel.zdy',
 ...
 /********************************************** Grid ***********************************************************/
   ...
   var functionGridPanel =  new Ext.grid.GridPanel({
        renderTo:"grid-size",title:'基础列表>>三层交换机',
        width:Ext.get("grid-size").getWidth(),height:Ext.get("grid-size").getHeight(),
        ...
        cm: new Ext.grid.ColumnModel([sm,
            ...
            {header:"设备名称", width: 140, sortable:true,dataIndex:'threeLayerSwitchName'},
            ...
            {header:"所属厂家", width: 140, sortable:true,dataIndex:'manufacturersName'},
            ...
            items:['-',{
            	 ...
            	 handler:function(){
            	 	var flag = 0;
            	  	/** 查询要导出的相应记录 */
						Ext.Ajax.request({
							 url: 'A_ThreeLayerSwitchServiceImpl!exportExcel.zdy',
							 params: {
            	 	...
            	 	var _record = functionGridPanel.getSelectionModel().getSelected();
           		 	if (_record){ 
           		 		var _jsonData = functionGridPanel.getSelectionModel().getSelections()[0];
			 				Ext.getCmp("updateThreeLayerSwitchId").setValue(_jsonData.get("threeLayerSwitchId"));
							Ext.getCmp("updateThreeLayerSwitchName").setValue(_jsonData.get("threeLayerSwitchName"));
           		 ...
           		 handler:function(){
           		 	...
           		 	if (_record){
           		 		Ext.MessageBox.confirm('确认启用', '确认要启用选择的数据吗？', function(btn){
								...
								for (var i = 0;i <len; i++){
									if (i == 0) {
										_jsonData = _jsonData +  m[i].get("threeLayerSwitchId");
									} else {
										_jsonData = _jsonData + "," +  m[i].get("threeLayerSwitchId");
									}
								}
								/** 更新相应记录 */
								Ext.Ajax.request({
									   url: 'A_ThreeLayerSwitchServiceImpl!effective.zdy',
           		 ...
           		 handler:function(){
           		 	...
           		 	if (_record){
           		 		Ext.MessageBox.confirm('确认停用', '确认要停用选择的数据吗？', function(btn){
								...
								/** 更新相应记录 */
								Ext.Ajax.request({
									   url: 'A_ThreeLayerSwitchServiceImpl!invalid.zdy',
									   params: {"ids":_jsonData},
									   success: function(response,options){
									   		 ajaxSuccess(response,options);
									   },
           		 ...
           		 handler:function(){
           		 	...
           		 	if (_record){
           		 		Ext.MessageBox.confirm('确认删除', '确认要删除选择的数据吗？', function(btn){
								...
								/** 更新相应记录 */
								Ext.Ajax.request({
									   url: 'A_ThreeLayerSwitchServiceImpl!delete.zdy',
									   params: {"ids":_jsonData},
									   success: function(response,options){
									   		ajaxSuccess(response,options);
									   },
   ...
   /*********************************************** 事件初始化*******************************************************/
	...
	var onrowdoubleclick = function(functionGridPanel, index, e){
         ...
         if (_record){
           	var _jsonData = functionGridPanel.getSelectionModel().getSelections()[0];
			Ext.getCmp("viewThreeLayerSwitchName").setValue(_jsonData.get("threeLayerSwitchName"));
	...
	function conditionFiledSelect(){
		...
		if(Ext.getCmp('conditionFiled').getValue()=='threeLayerSwitch.delFlg'){
			Ext.getCmp('conditionFiledPanel').add(new Ext.form.ComboBox({
				id:"conditionValue",xtype:'combo',fieldLabel:'查询内容',
				mode:'local',store:delFlgStore,
				typeAhead:true,triggerAction:'all',forceSelection:true
			}));
		}else if(Ext.getCmp('conditionFiled').getValue()=='threeLayerSwitch.siteId'){
			Ext.getCmp('conditionFiledPanel').add(new Ext.form.ComboBox({
				id:"conditionValue",xtype:'combo',fieldLabel:'查询内容',
				typeAhead:true,triggerAction:'all',forceSelection:true,
		...
		}else if(Ext.getCmp('conditionFiled').getValue()=='threeLayerSwitch.projectId'){
			Ext.getCmp('conditionFiledPanel').add(new Ext.form.ComboBox({
				id:"conditionValue",xtype:'combo',fieldLabel:'查询内容',
				typeAhead:true,triggerAction:'all',forceSelection:true,
		...
		}else if(Ext.getCmp('conditionFiled').getValue()=='threeLayerSwitch.constructionUnitId'){
			Ext.getCmp('conditionFiledPanel').add(new Ext.form.ComboBox({
				id:"conditionValue",xtype:'combo',fieldLabel:'查询内容',
				typeAhead:true,triggerAction:'all',forceSelection:true,
		...
		}else if(Ext.getCmp('conditionFiled').getValue()=='threeLayerSwitch.manufacturersId'){
			Ext.getCmp('conditionFiledPanel').add(new Ext.form.ComboBox({
				id:"conditionValue",xtype:'combo',fieldLabel:'查询内容',
				typeAhead:true,triggerAction:'all',forceSelection:true,
		...
		}else if(Ext.getCmp('conditionFiled').getValue()=='threeLayerSwitch.runTime'){
