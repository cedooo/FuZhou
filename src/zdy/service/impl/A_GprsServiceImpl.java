...
public class A_GprsServiceImpl extends Forward {
	...
	public void add(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			templateDao.add(request.getAttribute(Constant.A_GPRS));
	...
	public void update(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			TemplateDao templateDao = new TemplateDaoImpl();
			templateDao.update(request.getAttribute(Constant.A_GPRS));
	...
	public void query(HttpServletRequest request, HttpServletResponse response)
		...
		String sql=" select gprs.*,project.projectName as projectName,site.siteName as siteName," +
		   ...
		   " left join a_site  site on(gprs.siteId  = site.siteId)" +
		   " left join b_manufacturers  manufacturers on(gprs.manufacturersId  = manufacturers.manufacturersId)" +
		   " left join b_constructionUnit constructionUnit on(gprs.constructionUnitId = constructionUnit.constructionUnitId) ";
		try {
			TemplateDao templateDao = new TemplateDaoImpl();
			Map<String, Object> map = templateDao.combinedQuery((ConditionDto) request
					.getAttribute(Constant.CONDITIONDTO), pageDto, Constant.A_GPRSDTO,sql);
			/** 将数据封装成json格式 */
	...
	public void exportExcel(HttpServletRequest request,
		...
		try {
			TemplateDao templateDao = new TemplateDaoImpl();
			Map<String, Object> map = templateDao.combinedQuery((ConditionDto) request
					.getAttribute(Constant.CONDITIONDTO),Constant.A_GPRSDTO,sql);
			/** 生成excel */
			SimpleDateFormat simpleDateFormat=new SimpleDateFormat("yyyy-MM-dd");
			String excelName="gprs表-"+simpleDateFormat.format(new Date())+".xls";
			String excelPath = Constant.EXPORTEXCELDIR +excelName;
			WritableWorkbook book = Workbook
					.createWorkbook(new File(excelPath));
			WritableSheet sheet = book.createSheet("区域列表", 0);
			/** 头部样式 */
			...
			Label headLabel1 = new Label(1, 0, "GPRS名称", headFormat);
			...
			Label headLabel7 = new Label(7, 0, "卡号", headFormat);
			sheet.addCell(headLabel7);
			sheet.setColumnView(7, 30);
			Label headLabel8 = new Label(8, 0, "运营商", headFormat);
			sheet.addCell(headLabel8);
			sheet.setColumnView(8, 30);
			Label headLabel9 = new Label(9, 0, "技术类型", headFormat);
			sheet.addCell(headLabel9);
			sheet.setColumnView(9, 30);
			Label headLabel10 = new Label(10, 0, "所属厂家", headFormat);
			sheet.addCell(headLabel10);
			sheet.setColumnView(10, 30);
			Label headLabel11 = new Label(11, 0, "型号规格", headFormat);
			sheet.addCell(headLabel11);
			sheet.setColumnView(11, 30);
			Label headLabel12 = new Label(12, 0, "所属施工单位", headFormat);
			sheet.addCell(headLabel12);
			sheet.setColumnView(12, 30);
			Label headLabel13 = new Label(13, 0, "投运时间", headFormat);
			...
			/** 正文内容 */
			int rowCount = 1;
			for (A_GprsDto a_GprsDto : (List<A_GprsDto>)map.get(Constant.BEENLIST)) {
				Label label0 = new Label(0, rowCount, String.valueOf(rowCount), bodyNormalFormat);
				sheet.addCell(label0);
				Label label1 = new Label(1, rowCount,a_GprsDto.getGprsName(), bodyNormalFormat);
				sheet.addCell(label1);
				Label label2 = new Label(2, rowCount,a_GprsDto.getSiteName(), bodyNormalFormat);
				sheet.addCell(label2);
				Label label3 = new Label(3, rowCount,a_GprsDto.getProjectName(), bodyNormalFormat);
				sheet.addCell(label3);
				Label label4 = new Label(4, rowCount,a_GprsDto.getInstallationSite(), bodyNormalFormat);
				sheet.addCell(label4);
				Label label5 = new Label(5, rowCount,a_GprsDto.getDebugging(), bodyNormalFormat);
				sheet.addCell(label5);
				Label label6 = new Label(6, rowCount,a_GprsDto.getIp(), bodyNormalFormat);
				sheet.addCell(label6);
				Label label7 = new Label(7, rowCount,a_GprsDto.getCardNumber(), bodyNormalFormat);
				sheet.addCell(label7);
				Label label8 = new Label(8, rowCount,a_GprsDto.getOperators(), bodyNormalFormat);
				sheet.addCell(label8);
				Label label9 = new Label(9, rowCount, a_GprsDto.getTechnologyType(), bodyNormalFormat);
				sheet.addCell(label9);
				Label label10 = new Label(10, rowCount, a_GprsDto.getManufacturersName(), bodyNormalFormat);
				sheet.addCell(label10);
				Label label11 = new Label(11, rowCount, a_GprsDto.getTypeSpecification(), bodyNormalFormat);
				sheet.addCell(label11);
				Label label12 = new Label(12, rowCount, a_GprsDto.getConstructionUnitName(), bodyNormalFormat);
				sheet.addCell(label12);
				Label label13 = new Label(13, rowCount, a_GprsDto.getRunTime(), bodyNormalFormat);
				sheet.addCell(label13);
				Label label14 = new Label(14, rowCount, a_GprsDto.getDelFlg(), bodyNormalFormat);
				sheet.addCell(label14);
				Label label15 = new Label(15, rowCount, a_GprsDto.getDescp(), bodyNormalFormat);
            	...
            	/** 判断是否是表单元素(<input type="text" />单选，多选等) */ 
            	 if (!item.isFormField()) {
                    ...
                    /** 未选择上传文件 */ 
            		 ...
            		 String fileName="gprs_"+String.valueOf(System.currentTimeMillis())+".xls";
                     ...
                     try{
	                     ...
	                     for(int i=1;i<rows;i++){
	                    	...
	                    	if(st.getCell(0,i).getContents()==null||"".equals(st.getCell(0,i).getContents())){
                     			printWriter.append(Method.getJsonFormat(Message.ERRORMESSAGE_IMPORT+"+'第"+exceptionIndex+"行的gprs名称为空'"));
                     			return;
	                    	}
	                    	...
	                    	/** 实例化gprs模型 */
	                    	A_Gprs gprs = new A_Gprs();
	                     	gprs.setGprsName(st.getCell(0,i).getContents());
	                     	/** 下拉框查询实例 */
	                    	...
	                    	conditionDtoForCombo.setOrderValue("asc");
	                     	...
	                     	gprs.setCardNumber(st.getCell(6,i).getContents());
	                     	gprs.setOperators(st.getCell(7,i).getContents());
	                     	gprs.setTechnologyType(st.getCell(8,i).getContents());
	                     	/** 获取所属厂家 */
	                    	conditionDtoForCombo.setConditionFiled("manufacturersName");
	                     	conditionDtoForCombo.setConditionValue(st.getCell(9,i).getContents());
	                     	...
	                     	gprs.setManufacturersId(manufacturersList.get(0).getManufacturersId());
	                     	gprs.setTypeSpecification(st.getCell(10,i).getContents());
	                     	/** 获取施工单位 */
	                    	conditionDtoForCombo.setConditionFiled("constructionUnitName");
	                     	conditionDtoForCombo.setConditionValue(st.getCell(11,i).getContents());
	                     	...
	                     	gprs.setConstructionUnitId(constructionUnitList.get(0).getConstructionUnitId());
	                     	gprs.setRunTime(st.getCell(12,i).getContents());
	                     	gprs.setDelFlg(st.getCell(13,i).getContents());
	                     	gprs.setDescp(st.getCell(14,i).getContents());
	                     	
	                     	TemplateDao templateDaoForTranscationAdd = new TemplateDaoImpl();
	                     	templateDaoForTranscationAdd.transcationAdd(gprs,dBManager);
	                     } 
	...
	public void downloadExcel(HttpServletRequest request,
		...
		try {
			...
			/** 表头内容+列宽 */
			Label headLabel0 = new Label(0, 0, "gprs名称(必填)", requiredFormat);
			gprsSheet.addCell(headLabel0);
			gprsSheet.setColumnView(0, 30);
			...
			gprsSheet.addCell(headLabel2);
			gprsSheet.setColumnView(2, 30);
			Label headLabel3 = new Label(3, 0, "安装地址", normalFormat);
			gprsSheet.addCell(headLabel3);
			gprsSheet.setColumnView(3, 30);
			Label headLabel4 = new Label(4, 0, "调试情况", normalFormat);
			gprsSheet.addCell(headLabel4);
			gprsSheet.setColumnView(4, 30);
			Label headLabel5 = new Label(5, 0, "IP地址", normalFormat);
			gprsSheet.addCell(headLabel5);
			gprsSheet.setColumnView(5, 30);
			Label headLabel6 = new Label(6, 0, "卡号", normalFormat);
			gprsSheet.addCell(headLabel6);
			gprsSheet.setColumnView(6, 30);
			Label headLabel7 = new Label(7, 0, "运营商", normalFormat);
			gprsSheet.addCell(headLabel7);
			gprsSheet.setColumnView(7, 30);
			Label headLabel8 = new Label(8, 0, "技术类型", normalFormat);
			gprsSheet.addCell(headLabel8);
			gprsSheet.setColumnView(8, 30);
			Label headLabel9 = new Label(9, 0, "所属厂家(必填)", requiredFormat);
			...
			headLabel9.setCellFeatures(manufacturersWritableCellFeatures);
			gprsSheet.addCell(headLabel9);
			gprsSheet.setColumnView(9, 30);
			Label headLabel10 = new Label(10, 0, "规格型号", normalFormat);
			gprsSheet.addCell(headLabel10);
			gprsSheet.setColumnView(10, 30);
			Label headLabel11 = new Label(11, 0, "施工单位(必填)", requiredFormat);
			...
			headLabel11.setCellFeatures(constructionUnitWritableCellFeatures);
			gprsSheet.addCell(headLabel11);
			gprsSheet.setColumnView(11, 30);
			Label headLabel12 = new Label(12, 0, "投运时间", normalFormat);
			gprsSheet.addCell(headLabel12);
			gprsSheet.setColumnView(12, 30);
			...
			gprsSheet.addCell(headLabel13);
			gprsSheet.setColumnView(13, 30);
			Label headLabel14 = new Label(14, 0, "备注", normalFormat);
			gprsSheet.addCell(headLabel14);
			gprsSheet.setColumnView(14, 30);
			/** 实例化查询接口 */
			TemplateDao templateDao = new TemplateDaoImpl();
			/** 站点集合 */
			{
