Ext.onReady(function(){
   ...
   var record_start = 0;
    /** combo下拉框-字段local初始化 */
    var conditionFiledStore = [['olt.oltName','olt名称'],['olt.siteId','所属站点'],['olt.projectId','所属项目'],
    						   ['olt.installationSite','安装地址'],['olt.manufacturersId','所属厂家'],['olt.typeSpecification','型号规格'],
    						   ['olt.constructionUnitId','施工单位'],['olt.vlanId','vlanId'],['olt.lookbackLocation','lookback地址'],
    						   ['olt.ospfNumber','ospf进程号'],['olt.vpnNumber','VPN实例名'],['olt.runTime','投运时间'],
    						   ['olt.delFlg','是否启用'],['olt.descp','备注']];
	...
	var gridPanelDataStore = new Ext.data.JsonStore({
    		url: 'A_OltServiceImpl!query.zdy',
    		baseParams:{start:0,limit:50},
    		root: 'beenList',
    		totalProperty : 'totalCount',
    		fields: ['oltId','oltName','siteId','siteName','projectId','projectName','installationSite',
    				 'manufacturersId','manufacturersName','typeSpecification','constructionUnitId','constructionUnitName',
    				 'runTime','vlanId','lookbackLocation','ospfNumber','vpnNumber','delFlg','descp']
		});
/********************************************* Form集合 ***********************************************************/
     	 /** form的提示信息位置 */
    	...
    	var formPanel_view = new Ext.FormPanel({
						        title: 'olt-查看',labelWidth:100,frame:true, 
						        ...
						        items: [{
							        		items:[{
							        				...
							        				items:[{id:"viewOltName",fieldLabel:'<font color="red">(*)</font>olt名称'}]
							        		}]
						            	},{
							            	 items:[{
									            	...
									            	items:[{id:"viewSiteName",fieldLabel:'<font color="red">(*)</font>所属站点'},
									            		   ...
									            		   {id:"viewLookbackLocation",fieldLabel:'lookback地址'},
									            		   {id:"viewVpnNumber",fieldLabel:'vpn实例名'}]
									            	},{
									            	layout:'form',columnWidth:.5,defaultType:'textfield',
									            	defaults:{labelStyle:"text-align:right;",anchor:'90%',readOnly:true}, 
									            	items:[{id:"viewProjectName",fieldLabel:'<font color="red">(*)</font>所属项目 '},
									            		   ...
									            		   {id:"viewOspfNumber",fieldLabel:'osppf进程号'},
    	...
    	var formPanel_add = new Ext.FormPanel({
						        title: 'olt-新增',labelWidth:100,frame:true, 
						        url:'A_OltServiceImpl!add.zdy',
						        defaults:{xtype: 'panel',layout: 'column',anchor:'100%'},
						        items:[{
						        		items:[{
						        				layout:'form',columnWidth:1,defaultType:'textfield', 
						        				...
						        				items:[{	
						        						name:'A_Olt.oltName',fieldLabel:'<font color="red">(*)</font>olt名称',
    													emptyText:"请输入olt名称",allowBlank:false,blankText:"olt名称不能为空" 
    											}]
						        		}]
						            },{
						            	items:[{
								            	...
								            	items:[{
										            		name:'A_Olt.siteId',xtype:'combo',fieldLabel:'<font color="red">(*)</font>所属站点',
										                	emptyText:'请选择所属站点',allowBlank:false,blankText:'所属站点不能为空',
										                	mode:'local',store:siteDataStore,hiddenName:'A_Olt.siteId',
										               		displayField:'siteName',valueField:'siteId',
										               	 	typeAhead:true,triggerAction:'all',forceSelection:true
								            	 	   },{
						              				 		name:'A_Olt.installationSite',fieldLabel:'安装地址'
						            				   },{
									               			name:'A_Olt.typeSpecification',fieldLabel:'型号规格'
									            	   },{
									               			name:'A_Olt.runTime',xtype:'datefield',fieldLabel:'投运时间',
									               			maxValue: new Date(),format:'Y-m-d',
						                					invalidText:"输入的日期格式不正确，请参考格式‘2014-01-01’格式"
									            	   },{
									               			name:'A_Olt.lookbackLocation',fieldLabel:'lookback地址'
									            	   },{
									               			name:'A_Olt.vpnNumber',fieldLabel:'vpn实例名'
									            	   }]
								            },{
								            	layout:'form',columnWidth:.5,defaultType:'textfield',
								            	defaults:{labelStyle:"text-align:right;",anchor:'90%'}, 
								            	items:[{
										            		name:'A_Olt.projectId',xtype:'combo',fieldLabel:'<font color="red">(*)</font>所属项目',
										               	 	emptyText:'请选择所属项目',allowBlank:false,blankText:'所属项目不能为空',
										               	 	mode:'local',store:projectDataStore,hiddenName:'A_Olt.projectId',
										                	displayField:'projectName',valueField:'projectId',
										                	typeAhead:true,triggerAction:'all',forceSelection:true
								            		},{
						                					name:'A_Olt.manufacturersId',xtype:'combo',fieldLabel:'<font color="red">(*)</font>所属厂家',
											                emptyText:'请选择所属厂家',allowBlank:false,blankText:'所属厂家不能为空',
											                mode:'local',store:manufacturersDataStore,hiddenName:'A_Olt.manufacturersId',
											                displayField:'manufacturersName',valueField:'manufacturersId',
											                typeAhead:true,triggerAction:'all',forceSelection:true
						           					},{
											                name:'A_Olt.constructionUnitId',xtype:'combo',fieldLabel:'<font color="red">(*)</font>施工单位',
											                emptyText:'请选择施工单位',allowBlank:false,blankText:'施工单位不能为空',
											                mode:'local',store:constructionUnitDataStore,hiddenName:'A_Olt.constructionUnitId',
											                displayField:'constructionUnitName',valueField:'constructionUnitId',
											                typeAhead:true,triggerAction:'all',forceSelection:true
									            	},{
						                					name:'A_Olt.vlanId',fieldLabel:'vlanId'
						           					},{
						                					name:'A_Olt.ospfNumber',fieldLabel:'ospf进程号'
						           					},{
											            	name:'A_Olt.delFlg',xtype:'combo',fieldLabel:'<font color="red">(*)</font>是否启用',
						        		...
						        		items:[{
						        				layout:'form',columnWidth:1,defaultType:'textfield', 
						            	 		defaults:{labelStyle:"text-align:right;",anchor:'95%'},
						        				items:[{	
						        					name:'A_Olt.descp',fieldLabel:'备注',xtype:'textarea'
    											}]
						        		}]
						           }
						        ]
    	...
    	var formPanel_update = new Ext.FormPanel({
						        title: 'olt-更新',labelWidth:100,frame:true, 
						        url:'A_OltServiceImpl!update.zdy',
						        defaults:{xtype: 'panel',layout: 'column',anchor:'100%'},
						       	items:[{
						        		items:[{
						        				layout:'form',columnWidth:1,defaultType:'textfield', 
						            	 		defaults:{labelStyle:"text-align:right;",anchor:'95%'},
						        				items:[{
						        						id:'updateOltId',name:'A_Olt.oltId',hidden:true
						        				},{	
						        						id:'updateOltName',name:'A_Olt.oltName',fieldLabel:'<font color="red">(*)</font>olt名称',
    													emptyText:"请输入olt名称",allowBlank:false,blankText:"olt名称不能为空" 
    											}]
						        		}]
						            },{
						            	items:[{
						            	 		...
						            	 		defaults:{labelStyle:"text-align:right;",anchor:'90%'},
								            	items:[{
										            	id:'updateSiteId',name:'A_Olt.siteId',xtype:'combo',fieldLabel:'<font color="red">(*)</font>所属站点',
										                emptyText:'请选择所属站点',allowBlank:false,blankText:'所属站点不能为空',
										                mode:'local',store:siteDataStore,hiddenName:'A_Olt.siteId',
										               	displayField:'siteName',valueField:'siteId',
										               	typeAhead:true,triggerAction:'all',forceSelection:true
								            	 	   },{
						              				 	id:'updateInstallationSite',name:'A_Olt.installationSite',fieldLabel:'安装地址'
						            				   },{
									               		id:'updateTypeSpecification',name:'A_Olt.typeSpecification',fieldLabel:'型号规格'
									            	   },{
									               		id:'updateRunTime',name:'A_Olt.runTime',xtype:'datefield',fieldLabel:'投运时间',
									               		maxValue: new Date(),format:'Y-m-d',
						                				invalidText:"输入的日期格式不正确，请参考格式‘2014-01-01’格式"
									            	   },{
									               		id:'updateLookbackLocation',name:'A_Olt.lookbackLocation',fieldLabel:'lookback地址'
									            	   },{
									               		id:'updateVpnNumber',name:'A_Olt.vpnNumber',fieldLabel:'VPN实例名'
									            	   }]
								            },{
								            	layout:'form',columnWidth:.5,defaultType:'textfield',
								            	defaults:{labelStyle:"text-align:right;",anchor:'90%'}, 
								            	items:[{
										            	id:'updateProjectId',name:'A_Olt.projectId',xtype:'combo',fieldLabel:'<font color="red">(*)</font>所属项目',
										               	emptyText:'请选择所属项目',allowBlank:false,blankText:'所属项目不能为空',
										               	mode:'local',store:projectDataStore,hiddenName:'A_Olt.projectId',
										                displayField:'projectName',valueField:'projectId',
										                typeAhead:true,triggerAction:'all',forceSelection:true
								            		},{
						                				id:'updateManufacturersId',name:'A_Olt.manufacturersId',xtype:'combo',fieldLabel:'<font color="red">(*)</font>所属厂家',
											            emptyText:'请选择所属厂家',allowBlank:false,blankText:'所属厂家不能为空',
											            mode:'local',store:manufacturersDataStore,hiddenName:'A_Olt.manufacturersId',
											            displayField:'manufacturersName',valueField:'manufacturersId',
											            typeAhead:true,triggerAction:'all',forceSelection:true
						           					},{
											            id:'updateConstructionUnitId',name:'A_Olt.constructionUnitId',xtype:'combo',fieldLabel:'<font color="red">(*)</font>施工单位',
											            emptyText:'请选择施工单位',allowBlank:false,blankText:'施工单位不能为空',
											            mode:'local',store:constructionUnitDataStore,hiddenName:'A_Olt.constructionUnitId',
											            displayField:'constructionUnitName',valueField:'constructionUnitId',
											            typeAhead:true,triggerAction:'all',forceSelection:true
									            	},{
						                				id:'updateVlanId',name:'A_Olt.vlanId',fieldLabel:'vlanId'
						           					},{
						                				id:'updateOspfNumber',name:'A_Olt.ospfNumber',fieldLabel:'ospf进程号'
						           					},{
											            id:'updateDelFlg',name:'A_Olt.delFlg',xtype:'combo',fieldLabel:'<font color="red">(*)</font>是否启用',
											            emptyText:"请选择是否启用",allowBlank:false,blankText:"是否启用不能为空",
											            mode:'local',store:delFlgStore,
											            typeAhead:true,triggerAction:'all',forceSelection:true
								             	}] 
						        		...
						        		items:[{
						        				layout:'form',columnWidth:1,defaultType:'textfield', 
						            	 		defaults:{labelStyle:"text-align:right;",anchor:'95%'},
						        				items:[{	
						        					id:'updateDescp',name:'A_Olt.descp',fieldLabel:'备注',xtype:'textarea'
    											}]
						        		}]
						           }
						        ]
		...
		var formPanel_import = new Ext.FormPanel({
						        title: 'olt-上传',labelWidth:100,
						        frame:true,fileUpload :true,
						        url:'A_OltServiceImpl!importExcel.zdy',
						        ...
						        buttons: [{
						            ...
						            handler:function(){
									   Ext.Ajax.request({
											url: 'A_OltServiceImpl!downloadExcel.zdy',
 ...
 /********************************************** Grid ***********************************************************/
   ...
   var functionGridPanel =  new Ext.grid.GridPanel({
        renderTo:"grid-size",title:'基础列表>>olt', width:Ext.get("grid-size").getWidth(),height:Ext.get("grid-size").getHeight(),
        ...
        cm: new Ext.grid.ColumnModel([sm,
            ...
            {header:"olt名称", width: 140, sortable:true,dataIndex:'oltName'},
            ...
            {header:"lookback地址", width: 120, sortable:true,dataIndex:'lookbackLocation'},
            {header:"ospf进程号", width: 120, sortable:true,dataIndex:'ospfNumber'},
            {header:"vpn实例名 ", width: 120, sortable:true,dataIndex:'vpnNumber'},
            ...
            items:['-',{
            	 ...
            	 handler:function(){
            	 	var flag = 0;
            	  	/** 查询要导出的相应记录 */
						Ext.Ajax.request({
							 url: 'A_OltServiceImpl!exportExcel.zdy',
							 params: {
            	 	...
            	 	var _record = functionGridPanel.getSelectionModel().getSelected();
           		 	if (_record){ 
           		 		var _jsonData = functionGridPanel.getSelectionModel().getSelections()[0];
			 				Ext.getCmp("updateOltId").setValue(_jsonData.get("oltId"));
							Ext.getCmp("updateOltName").setValue(_jsonData.get("oltName"));
							...
							Ext.getCmp("updateLookbackLocation").setValue(_jsonData.get("lookbackLocation"));
							Ext.getCmp("updateOspfNumber").setValue(_jsonData.get("ospfNumber"));
							Ext.getCmp("updateVpnNumber").setValue(_jsonData.get("vpnNumber"));
           		 ...
           		 handler:function(){
           		 	...
           		 	if (_record){
           		 		Ext.MessageBox.confirm('确认启用', '确认要启用选择的数据吗？', function(btn){
								...
								for (var i = 0;i <len; i++){
									if (i == 0) {
										_jsonData = _jsonData +  m[i].get("oltId");
									} else {
										_jsonData = _jsonData + "," +  m[i].get("oltId");
									}
								}
								/** 更新相应记录 */
								Ext.Ajax.request({
									   url: 'A_OltServiceImpl!effective.zdy',
           		 ...
           		 handler:function(){
           		 	...
           		 	if (_record){
           		 		Ext.MessageBox.confirm('确认停用', '确认要停用选择的数据吗？', function(btn){
								...
								/** 更新相应记录 */
								Ext.Ajax.request({
									   url: 'A_OltServiceImpl!invalid.zdy',
									   params: {"ids":_jsonData},
									   success: function(response,options){
									   		 ajaxSuccess(response,options);
									   },
           		 ...
           		 handler:function(){
           		 	...
           		 	if (_record){
           		 		Ext.MessageBox.confirm('确认删除', '确认要删除选择的数据吗？', function(btn){
								...
								/** 更新相应记录 */
								Ext.Ajax.request({
									   url: 'A_OltServiceImpl!delete.zdy',
									   params: {"ids":_jsonData},
									   success: function(response,options){
									   		ajaxSuccess(response,options);
									   },
   ...
   /*********************************************** 事件初始化*******************************************************/
	...
	var onrowdoubleclick = function(functionGridPanel, index, e){
         ...
         if (_record){
           	var _jsonData = functionGridPanel.getSelectionModel().getSelections()[0];
			Ext.getCmp("viewOltName").setValue(_jsonData.get("oltName"));
			...
			Ext.getCmp("viewLookbackLocation").setValue(_jsonData.get("lookbackLocation"));
			Ext.getCmp("viewOspfNumber").setValue(_jsonData.get("ospfNumber"));
			Ext.getCmp("viewVpnNumber").setValue(_jsonData.get("vpnNumber"));
	...
	function conditionFiledSelect(){
		...
		if(Ext.getCmp('conditionFiled').getValue()=='olt.delFlg'){
			Ext.getCmp('conditionFiledPanel').add(new Ext.form.ComboBox({
				id:"conditionValue",xtype:'combo',fieldLabel:'查询内容',
				mode:'local',store:delFlgStore,
				typeAhead:true,triggerAction:'all',forceSelection:true
			}));
		}else if(Ext.getCmp('conditionFiled').getValue()=='olt.siteId'){
			Ext.getCmp('conditionFiledPanel').add(new Ext.form.ComboBox({
				id:"conditionValue",xtype:'combo',fieldLabel:'查询内容',
				typeAhead:true,triggerAction:'all',forceSelection:true,
		...
		}else if(Ext.getCmp('conditionFiled').getValue()=='olt.projectId'){
			Ext.getCmp('conditionFiledPanel').add(new Ext.form.ComboBox({
				id:"conditionValue",xtype:'combo',fieldLabel:'查询内容',
				typeAhead:true,triggerAction:'all',forceSelection:true,
		...
		}else if(Ext.getCmp('conditionFiled').getValue()=='olt.constructionUnitId'){
			Ext.getCmp('conditionFiledPanel').add(new Ext.form.ComboBox({
				id:"conditionValue",xtype:'combo',fieldLabel:'查询内容',
				typeAhead:true,triggerAction:'all',forceSelection:true,
		...
		}else if(Ext.getCmp('conditionFiled').getValue()=='olt.manufacturersId'){
			Ext.getCmp('conditionFiledPanel').add(new Ext.form.ComboBox({
				id:"conditionValue",xtype:'combo',fieldLabel:'查询内容',
				typeAhead:true,triggerAction:'all',forceSelection:true,
		...
		}else if(Ext.getCmp('conditionFiled').getValue()=='olt.runTime'){
