Ext.onReady(function(){
   ...
   var record_start = 0;
    ...
    var conditionFiledStore = [['gprs.gprsName','gprs名称'],['gprs.siteId','所属站点'],['gprs.projectId','所属项目'],
    						   ...
    						   ['gprs.runTime','投运时间'],['gprs.delFlg','是否启用'],['gprs.descp','备注']];
	...
	var gridPanelDataStore = new Ext.data.JsonStore({
    		url: 'A_GprsServiceImpl!query.zdy',
    		baseParams:{start:0,limit:50},
    		root: 'beenList',
    		totalProperty : 'totalCount',
    		fields: ['gprsId','gprsName','siteId','siteName','projectId','projectName','installationSite',
    				 'debugging','ip','cardNumber','operators','technologyType','manufacturersId','manufacturersName',
    				 'typeSpecification','constructionUnitId','constructionUnitName','runTime','delFlg','descp']
		});
/********************************************* Form集合 ***********************************************************/
     	 /** form的提示信息位置 */
    	...
    	var formPanel_view = new Ext.FormPanel({
						        title: 'grps-查看',labelWidth:100,frame:true, 
						        ...
						        items: [{
							        		items:[{
							        				...
							        				items:[{id:"viewGprsName",fieldLabel:'<font color="red">(*)</font>gprs名称'}]
							        		}]
						            	},{
							            	 items:[{
										             ...
										             items:[{id:"viewSiteName",fieldLabel:'<font color="red">(*)</font>所属站点'},
										            		...
										            		{id:"viewOperators",fieldLabel:'运营商'},
    	...
    	var formPanel_add = new Ext.FormPanel({
						        title: 'grps-新增',labelWidth:100,frame:true, 
						        url:'A_GprsServiceImpl!add.zdy',
						        defaults:{xtype: 'panel',layout: 'column',anchor:'100%'},
						        items:[{
						        		items:[{
						        				layout:'form',columnWidth:1,defaultType:'textfield', 
						        				...
						        				items:[{	
						        						name:'A_Gprs.gprsName',fieldLabel:'<font color="red">(*)</font>gprs名称',
    													emptyText:"请输入gprs名称",allowBlank:false,blankText:"gprs名称不能为空" 
    											}]
						        		}]
						            },{
						            	items:[{
								            	...
								            	items:[{
										            		name:'A_Gprs.siteId',xtype:'combo',fieldLabel:'<font color="red">(*)</font>所属站点',
										                	emptyText:'请选择所属站点',allowBlank:false,blankText:'所属站点不能为空',
										                	mode:'local',store:siteDataStore,hiddenName:'A_Gprs.siteId',
										               		displayField:'siteName',valueField:'siteId',
										               	 	typeAhead:true,triggerAction:'all',forceSelection:true
								            	 	   },{
						              				 		name:'A_Gprs.installationSite',fieldLabel:'安装地址'
						            				   },{
											            	name:'A_Gprs.ip',fieldLabel:'IP地址'
									            	   },{
									               			 name:'A_Gprs.operators',fieldLabel:'运营商'
									            	   },{
									               			name:'A_Gprs.manufacturersId',xtype:'combo',fieldLabel:'<font color="red">(*)</font>所属厂家',
											                emptyText:'请选择所属厂家',allowBlank:false,blankText:'所属厂家不能为空',
											                mode:'local',store:manufacturersDataStore,hiddenName:'A_Gprs.manufacturersId',
											                displayField:'manufacturersName',valueField:'manufacturersId',
											                typeAhead:true,triggerAction:'all',forceSelection:true
									            	   },{
											                name:'A_Gprs.constructionUnitId',xtype:'combo',fieldLabel:'<font color="red">(*)</font>施工单位',
											                emptyText:'请选择施工单位',allowBlank:false,blankText:'施工单位不能为空',
											                mode:'local',store:constructionUnitDataStore,hiddenName:'A_Gprs.constructionUnitId',
								            	...
								            	items:[{
						                					...
						                					name:'A_Gprs.debugging',fieldLabel:'调试情况'
						           					},{
									              		    name:'A_Gprs.cardNumber',fieldLabel:'卡号'
									           		},{
									              		    name:'A_Gprs.technologyType',fieldLabel:'技术类型'
									           		},{
									              		    name:'A_Gprs.typeSpecification',fieldLabel:'型号规格'
									           		},{
									               			name:'A_Gprs.runTime',xtype:'datefield',fieldLabel:'投运时间',
						        		...
						        		items:[{
						        				layout:'form',columnWidth:1,defaultType:'textfield', 
						            	 		defaults:{labelStyle:"text-align:right;",anchor:'95%'},
						        				items:[{	
						        					name:'A_Gprs.descp',fieldLabel:'备注',xtype:'textarea'
    											}]
						        		}]
						           }
						        ]
    	...
    	var formPanel_update = new Ext.FormPanel({
						        title: 'grps-更新',labelWidth:100,frame:true, 
						        url:'A_GprsServiceImpl!update.zdy',
						        defaults:{xtype: 'panel',layout: 'column',anchor:'100%'},
						       	items:[{
						        		items:[{
						        				layout:'form',columnWidth:1,defaultType:'textfield', 
						            	 		defaults:{labelStyle:"text-align:right;",anchor:'95%'},
						        				items:[{
						        						id:'updateGprsId',name:'A_Gprs.gprsId',hidden:true
						        				},{	
						        						id:'updateGprsName',name:'A_Gprs.gprsName',fieldLabel:'<font color="red">(*)</font>gprs名称',
    													emptyText:"请输入gprs名称",allowBlank:false,blankText:"gprs名称不能为空" 
    											}]
						        		}]
						            },{
						            	items:[{
						            	 		...
						            	 		defaults:{labelStyle:"text-align:right;",anchor:'90%'},
								            	items:[{
										            	id:'updateSiteId',name:'A_Gprs.siteId',xtype:'combo',fieldLabel:'<font color="red">(*)</font>所属站点',
										                emptyText:'请选择所属站点',allowBlank:false,blankText:'所属站点不能为空',
										                mode:'local',store:siteDataStore,hiddenName:'A_Gprs.siteId',
										               	displayField:'siteName',valueField:'siteId',
										               	typeAhead:true,triggerAction:'all',forceSelection:true
								            	 	 },{
						              				 	id:'updateInstallationSite',name:'A_Gprs.installationSite',fieldLabel:'安装地址'
						            				 },{
											            id:'updateIp',name:'A_Gprs.ip',fieldLabel:'IP地址'
									            	 },{
									               		id:'updateOperators',name:'A_Gprs.operators',fieldLabel:'运营商'
									            	 },{
									               		id:'updateManufacturersId',name:'A_Gprs.manufacturersId',xtype:'combo',fieldLabel:'<font color="red">(*)</font>所属厂家',
											            emptyText:'请选择所属厂家',allowBlank:false,blankText:'所属厂家不能为空',
											            mode:'local',store:manufacturersDataStore,hiddenName:'A_Gprs.manufacturersId',
											            displayField:'manufacturersName',valueField:'manufacturersId',
											            typeAhead:true,triggerAction:'all',forceSelection:true
									            	 },{
											            id:'updateConstructionUnitId',name:'A_Gprs.constructionUnitId',xtype:'combo',fieldLabel:'<font color="red">(*)</font>施工单位',
											            emptyText:'请选择施工单位',allowBlank:false,blankText:'施工单位不能为空',
											            mode:'local',store:constructionUnitDataStore,hiddenName:'A_Gprs.constructionUnitId',
											            displayField:'constructionUnitName',valueField:'constructionUnitId',
											            typeAhead:true,triggerAction:'all',forceSelection:true
								            	...
								            	items:[{
						                				...
						                				id:'updateDebugging',name:'A_Gprs.debugging',fieldLabel:'调试情况'
						           					},{
									              		id:'updateCardNumber',name:'A_Gprs.cardNumber',fieldLabel:'卡号'
									           		},{
									              		id:'updateTechnologyType',name:'A_Gprs.technologyType',fieldLabel:'技术类型'
									           		},{
									              		id:'updateTypeSpecification',name:'A_Gprs.typeSpecification',fieldLabel:'型号规格'
									           		},{
									               		id:'updateRunTime',name:'A_Gprs.runTime',xtype:'datefield',fieldLabel:'投运时间',
									               		maxValue: new Date(),format:'Y-m-d',
						                				invalidText:"输入的日期格式不正确，请参考格式‘2014-01-01’格式"
									            	}] 
						            	}]
						        		...
						        		items:[{
						        				layout:'form',columnWidth:1,defaultType:'textfield', 
						            	 		defaults:{labelStyle:"text-align:right;",anchor:'95%'},
						        				items:[{	
						        					id:'updateDescp',name:'A_Gprs.descp',fieldLabel:'备注',xtype:'textarea'
    											}]
						        		}]
						           }
						        ]
		...
		var formPanel_import = new Ext.FormPanel({
						        title: 'grps-上传',labelWidth:100,
						        frame:true,fileUpload :true,
						        url:'A_GprsServiceImpl!importExcel.zdy',
						        ...
						        buttons: [{
						            ...
						            handler:function(){
									   Ext.Ajax.request({
											url: 'A_GprsServiceImpl!downloadExcel.zdy',
 ...
 /********************************************** Grid ***********************************************************/
   ...
   var functionGridPanel =  new Ext.grid.GridPanel({
        renderTo:"grid-size",title:'基础列表>>grps', width:Ext.get("grid-size").getWidth(),height:Ext.get("grid-size").getHeight(),
        ...
        cm: new Ext.grid.ColumnModel([sm,
            ...
            {header:"gprs名称", width: 140, sortable:true,dataIndex:'gprsName'},
            ...
            {header:"卡号", width: 120, sortable:true,dataIndex:'cardNumber'},
            {header:"运营商", width: 120, sortable:true,dataIndex:'operators'},
            {header:"技术类型", width: 120, sortable:true,dataIndex:'technologyType'},
            	 	...
            	 	var _record = functionGridPanel.getSelectionModel().getSelected();
           		 	if (_record){ 
           		 		var _jsonData = functionGridPanel.getSelectionModel().getSelections()[0];
			 				Ext.getCmp("updateGprsId").setValue(_jsonData.get("gprsId"));
							Ext.getCmp("updateGprsName").setValue(_jsonData.get("gprsName"));
							...
							Ext.getCmp("updateCardNumber").setValue(_jsonData.get("cardNumber"));
							Ext.getCmp("updateOperators").setValue(_jsonData.get("operators"));
							Ext.getCmp("updateTechnologyType").setValue(_jsonData.get("technologyType"));
           		 ...
           		 handler:function(){
           		 	...
           		 	if (_record){
           		 		Ext.MessageBox.confirm('确认启用', '确认要启用选择的数据吗？', function(btn){
								...
								for (var i = 0;i <len; i++){
									if (i == 0) {
										_jsonData = _jsonData +  m[i].get("gprsId");
									} else {
										_jsonData = _jsonData + "," +  m[i].get("gprsId");
									}
								}
								/** 更新相应记录 */
								Ext.Ajax.request({
									   url: 'A_GprsServiceImpl!effective.zdy',
           		 ...
           		 handler:function(){
           		 	...
           		 	if (_record){
           		 		Ext.MessageBox.confirm('确认停用', '确认要停用选择的数据吗？', function(btn){
								...
								/** 更新相应记录 */
								Ext.Ajax.request({
									   url: 'A_GprsServiceImpl!invalid.zdy',
									   params: {"ids":_jsonData},
									   success: function(response,options){
									   		 ajaxSuccess(response,options);
									   },
           		 ...
           		 handler:function(){
           		 	...
           		 	if (_record){
           		 		Ext.MessageBox.confirm('确认删除', '确认要删除选择的数据吗？', function(btn){
								...
								/** 更新相应记录 */
								Ext.Ajax.request({
									   url: 'A_GprsServiceImpl!delete.zdy',
									   params: {"ids":_jsonData},
									   success: function(response,options){
									   		ajaxSuccess(response,options);
									   },
   ...
   /*********************************************** 事件初始化*******************************************************/
	...
	var onrowdoubleclick = function(functionGridPanel, index, e){
         ...
         if (_record){
           	var _jsonData = functionGridPanel.getSelectionModel().getSelections()[0];
			Ext.getCmp("viewGprsName").setValue(_jsonData.get("gprsName"));
			...
			Ext.getCmp("viewCardNumber").setValue(_jsonData.get("cardNumber"));
			Ext.getCmp("viewOperators").setValue(_jsonData.get("operators"));
			Ext.getCmp("viewTechnologyType").setValue(_jsonData.get("technologyType"));
	...
	function conditionFiledSelect(){
		...
		}else if(Ext.getCmp('conditionFiled').getValue()=='gprs.runTime'){
