 ...
 * @version 1.0
 */
public class A_ThreeLayerSwitch extends TemplateBeen {
	/** 业务主键 */
	private String threeLayerSwitchId;
	/** 设备名称 */
	private String threeLayerSwitchName;
	/** 所属站点 */
	...
	/**
	 * @param vlanDescp the vlanDescp to set
	 */
